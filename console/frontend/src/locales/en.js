...
export const en = {
  ...
  sparkDeskModel: 'AiFlow Model, AiFlow',
  ...
  v1point5Conference: 'AiFlow V1.5 Upgrade News Conference',
  purity: 'Flat',
  immersion: 'Dark',
  ...
  outputTip: 'The text is generated by AiFlow LLM.',
  stopOutput: 'Stop',
  ...
  experienceRules: 'AiFlow User Experience Rules',
  privacyPolicy: 'AiFlow Privacy Policy',
  testTip:
  ...
  sparkHome: 'AiFlow',
  sparkIntro1: 'I am AiFlow Cognition LLM',
  sparkIntro2:
  ...
  botIntro:
    'You can use AiFlow Assistant to configure a scenario and tasks with one key.',
  botIntroNew:
    'You can use AiFlow Assistant to configure a scenario and tasks with one key.',
  changeBatch: 'Change',
  QandA: 'Q&A',
  ...
  sparkBotCenter: 'AiFlow Assistant Center',
  botSubTip:
  ...
  siteTitle: 'AiFlow Cognition LLM',
  entry: 'entry',
  ...
  more: 'more',
  sparkdeskUseTip:
    'The content generated by AiFlow AI model is for your reference only.',
  beianTip:
  ...
  sparkAiSearch: 'AiFlow AI Search',
